...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Latlander/flexsearch.min.js');loadScript('/Latlander/en.search-data.min.8ad10b60d67f0de940f678c1dd4a3fc7fbed9f22cd4857afb56c9ccf0885690e.js',function(){input.required=false;search();});}
