...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Latlander/flexsearch.min.js');loadScript('/Latlander/en.search-data.min.4feed00022d495e7a5a2e6d5ff5967011345d61e5db06871d2fa887e9a7e98d3.js',function(){input.required=false;search();});}
