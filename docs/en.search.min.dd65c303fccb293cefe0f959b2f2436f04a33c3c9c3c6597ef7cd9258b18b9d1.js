...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/latlander/flexsearch.min.js');loadScript('/latlander/en.search-data.min.faa70108712e577050d9d1bb77b6ccc07a0ff6fa512dcf5a5a15363c4148fe09.js',function(){input.required=false;search();});}
